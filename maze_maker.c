...
void file_reader(char *file_name, int** maze)
{
    ...
    {
        if(allocated == false) maze = allocate_matrix(size[0], size[1]);
        else memset(maze, 0, sizeof(maze));
...
/**
 * @brief funçao de alocaçao da matriz/labirinto a ser avaliada.
 * 
